...
| `test_java_generalization.py` | — | Category regression: implicit Dockerfile, published-port fallback, Maven-without-compose, Maven `-Pprod clean verify` build command from README, empty-repo guard, jpetstore not modified |
